    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column label="操作设备" align="center">
                    <template slot-scope="scope">
                        {{scope.row.deviceName}}
                    </template>
                </el-table-column>
                <el-table-column label="设备图标" align="center">
                    <template slot-scope="scope">
                        <img class="image" :src="require(`../assets/device/${scope.row.deviceType}.png` )"/>
                    </template>
                </el-table-column>
                <el-table-column label="操作指令" align="center">
                    <template slot-scope="scope">
                        {{scope.row.operate}}
                    </template>
                </el-table-column>
...
<script>
    import {
       getRecordAll,deleteRecordData,deleteRecords
    } from "@/api/api";
        ...
        methods: {
            ...
            delAllSelection() {
                this.$confirm('确定要删除所选数据吗？', '提示', {
                    ...
                    .then(() => {
                        deleteRecords(this.multipleSelection).then(res => {
                            if (res.code === 0) {
