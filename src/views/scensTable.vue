    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 情景信息
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column label="编号" align="center" type="index" :index="hIndex" :width="100">
                </el-table-column>
                <el-table-column label="情景Id" align="center">
                ...
                <el-table-column label="图标" align="center">
                    <template slot-scope="scope">
                        <img class="image" :src="require(`../assets/scens/${scope.row.iconId}.png` )"/>
                    </template>
                </el-table-column>
                <el-table-column label="操作模式" align="center">
                    <template slot-scope="scope">
                        {{scope.row.mode}}
                    </template>
                </el-table-column>
...
<script>
    import {
        getScenarioAll, deleteScenarioData, deleteScenarios, deleteDevices
    } from "@/api/api";
        ...
        methods: {
            ...
            delAllSelection() {
                this.$confirm('确定要删除所选数据吗？', '提示', {
                    ...
                    .then(() => {
                        deleteScenarios(this.multipleSelection).then(res => {
                            console.log(res)
                            if (res.code === 0) {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        deleteScenarioData(row).then(res => {
                            if (res.code === 0) {
                                this.$message.success(res.message)
                                this.getScenario()
                            } else {
